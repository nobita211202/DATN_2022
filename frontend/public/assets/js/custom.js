(function ($) {
    ...
    const bodyRtl = $('body').hasClass('rtl');
    if (bodyRtl) {
        $('body').addClass('rtl');
    ...
    const bodyhorizontal = $('body').hasClass('horizontal');
    if (bodyhorizontal) {
        ActiveSubmenu();
        $('body').addClass('horizontal');
    ...
    light();
    const bodyhorizontalHover = $('body').hasClass('horizontal-hover');
...
function replay() {
    ...
    const replayButtom = document.querySelectorAll('.reply a')
    // Creating Div
