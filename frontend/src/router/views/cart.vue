...
<template>
  <div>
    ...
    >
      ...
      <div class="position-static" v-if="lstCourse.length === 0">
      ...
      <div class="container px-0 mt-2 ">
        <div v-if="lstCourse.length !== 0" class="my-5 ">
          <span class="d-flex mb-2 p-3 bg-success row text-white">
            ...
            <div class="col-lg-7 col-12">
              <div v-for="cs,index in lstCourse" :key="index" class="d-flex py-2 border-bottom">
                ...
                <span class="mx-2">
                  ...
                  <span class="d-flex text-danger">{{cs.price | formatNumber}}</span>
                </span>
                <span class="ms-auto d-flex">
                  <b @click="mdrmCourse(cs.id,cs.name)" class="btn my-auto">
          ...
          <div class="radius mt-5 row bg-white py-5 bg-white">
...
export default {
  ...
  methods:{
    rmCourse(id){
      this.lstCourse = this.lstCourse.filter(c => c.id !== id)
      this.lstIdCourse = this.lstIdCourse.filter( c => c !== id)
      this.$cookie.set("courses",JSON.stringify(this.lstIdCourse))
      console.log(this.lstIdCourse);
