        ...
        <div class="footer border-top-0 bg-dark  bottom-0 w-100 ">
          <div class="container ">
            ...
            <div class="row mb-5 text-white">
                    ...
                    <div class="col-4 d-flex border border-white border-top-0 border-bottom-0">
                        <span class="px-2 mx-auto text-center">
                    ...
                    <div class="col-4 d-flex">
                        <span class="text-center text-white m-auto">
                            <p>©2023 DATN.</p>
                            <p>Webside fpolycourse.xyz/</p>
                        </span>
                    </div>
                </div>
